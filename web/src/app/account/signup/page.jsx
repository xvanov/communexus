      ...
      >
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="overflow-hidden rounded-lg border border-gray-200 bg-white px-4 py-3 focus-within:border-[#007AFF] focus-within:ring-1 focus-within:ring-[#007AFF]">
              <input
                required
                name="name"
                type="text"
